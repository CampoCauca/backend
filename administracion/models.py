...
class Stock(models.Model):
    ...
    class Meta:
        ...
        db_table_comment = 'Esta entidad se crea con el objetivo de llevar un inventario de los articulos que se encuentran disponibles y su valor unitario de compra y venta'
    def __str__(self):
        txt = "{5}"
        return txt.format(self.movimiento_id_movimiento)
