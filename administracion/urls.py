...
urlpatterns = [
    ...
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Empresa o registro de la Base de Datos 
    path('empresa/editar/<int:pk>', EmpresaActualizar.as_view(template_name = "crud/empresa/actualizar.html"), name='actualizarem'), 
 
    # La ruta 'eliminar' que usaremos para eliminar un  o reEmpresagistro de la Base de Datos 
    ...
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Metodo de pago o registro 
    path('metodo_pago/detalle/<int:pk>', MetodoPagoDetalle.as_view(template_name = "crud/metodo_pago/detalle.html"), name='detallesme'),
 
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Metodo de pago o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Metodo de pago o registro de la Base de Datos 
    ...
    # La ruta 'eliminar' que usaremos para eliminar un Metodo de pago o registro de la Base de Datos 
  ...
  #--------------------------------------------URL Departamento------------------------------------------------------------------------#
    ...
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Departamento o registro de la Base de Datos 
...
#--------------------------------------------URL TipoIdentificacion ------------------------------------------------------------------------#
    ...
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un tipo identificacion o registro 
    ...
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Tipo Identificacion o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Tipo Identificacion o registro de la Base de Datos 
    ...
    # La ruta 'eliminar' que usaremos para eliminar un Tipo Identificacion o registro de la Base de Datos 
...
#--------------------------------------------URL TipoPersona ------------------------------------------------------------------------#
    ...
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Tipo Persona o registro 
    ...
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Tipo Persona o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Tipo Persona o registro de la Base de Datos 
    ...
    # La ruta 'eliminar' que usaremos para eliminar un Tipo Persona o registro de la Base de Datos 
...
#--------------------------------------------URL TipoDocumento ------------------------------------------------------------------------#
    ...
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Tipo Documento o registro 
    ...
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Tipo Documento o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Tipo Documento o registro de la Base de Datos 
    ...
    # La ruta 'eliminar' que usaremos para eliminar un Tipo Documento o registro de la Base de Datos 
...
#--------------------------------------------URL Persona ------------------------------------------------------------------------#
    ...
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Persona o registro de la Base de Datos 
...
#-------------------------------------------- URL DjangoMigrations------------------------------------------------------------------------#
    
    path('django_migrations/', ListadoDjangoMigrations.as_view(template_name = "crud/django_migrations/tables.html"), name='leerdjm'),
 
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Django Migrations o registro 
    ...
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Django Migrations o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Django Migrations o registro de la Base de Datos 
    ...
    # La ruta 'eliminar' que usaremos para eliminar un Django Migrations o registro de la Base de Datos 
...
#--------------------------------------------URL auth_user_user_permissions ------------------------------------------------------------------------#
    ...
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un auth_user_user_permissions  o registro 
    ...
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo auth_user_user_permissions  o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un auth_user_user_permissions  o registro de la Base de Datos 
    ...
    # La ruta 'eliminar' que usaremos para eliminar un auth_user_user_permissions  o registro de la Base de Datos 
...
#----------------------------------------url cabeza-----------------------------------------------------#
 ...
 #Porque este metodo de pago aquí
    path('metodo_pago/eliminar/<int:pk>', MetodoPagoEliminar.as_view(), name='crud/metodo_pago/eliminar.html'),
#----------------------------------------url cabeza-----------------------------------------------------#
...
#--------------------------------------------URL Articulo------------------------------------------------------------------------#
    ...
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Articulo o registro 
    path('articulo/detalle/<int:pk>', ArticuloDetalle.as_view(template_name = "crud/articulo/detalle.html"), name='detallesart'),
 
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Articulo o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Articulo o registro de la Base de Datos 
    path('articulo/editar/<int:pk>', ArticuloActualizar.as_view(template_name = "crud/articulo/actualizar.html"), name='actualizarart'), 
 
    # La ruta 'eliminar' que usaremos para eliminar un Articulo o registro de la Base de Datos 
    ...
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un AuthGroupPermissions o registro 
    ...
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo AuthGroupPermissions o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un AuthGroupPermissions o registro de la Base de Datos 
    ...
    # La ruta 'eliminar' que usaremos para eliminar un AuthGroupPermissions o registro de la Base de Datos 
    ...
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un AuthPermission o registro 
    ...
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo AuthPermission o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un AuthPermission o registro de la Base de Datos 
    ...
    # La ruta 'eliminar' que usaremos para eliminar un AuthPermission o registro de la Base de Datos 
    ...
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Cuerpo o registro de la Base de Datos 
  ...
  #--------------------------------------------URL Unidad_de_Medida------------------------------------------------------------------------#
    ...
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un Unidad_de_Medida o registro 
    ...
    # La ruta 'crear' en donde mostraremos un formulario para crear un nuevo Unidad_de_Medida o registro  
    #path('zona/crear', ZonaCrear.as_view(template_name = "crud/zona/crear.html"), name='crearre'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un Unidad_de_Medida o registro de la Base de Datos 
    ...
    # La ruta 'eliminar' que usaremos para eliminar un Unidad_de_Medida o registro de la Base de Datos 
