...
#----------------------------------------url cabeza-----------------------------------------------------#
    # Ruta para listar 
    path('cabeza/', ListadoCabeza.as_view(), name='leercab'),

    # Ruta para ver los detalles
    path('cabeza/detalle/<int:pk>', CabezaDetalle.as_view(), name='detallescab'),

    # Ruta para crear 
    path('cabeza/crear', CabezaCrear.as_view(), name='crearcab'),

    # Ruta para actualizar 
    path('cabeza/editar/<int:pk>', CabezaActualizar.as_view(), name='actualizarcab'),
...
#--------------------------------------------URL Articulo------------------------------------------------------------------------#
  ...
  #--------------------------------------------URL Unidad_de_Medida------------------------------------------------------------------------#
    ...
    #--------------------------------------------URL Stock------------------------------------------------------------------------#
    # Ruta para listar
    path('stock/', ListadoStock.as_view(template_name="crud/Stock/listado.html"), name='leerstock'),

    # Ruta para ver los detalles
    path('stock/detalle/<int:pk>/', StockDetalle.as_view(), name='detallesstock'),

    # Ruta para crear
    path('stock/crear/', StockCrear.as_view(), name='crearstock'),

# Ruta para actualizar
    path('stock/editar/<int:pk>/', StockActualizar.as_view(), name='actualizarstock'),

# Ruta para eliminar
    path('stock/eliminar/<int:pk>/', StockEliminar.as_view(), name='eliminarstock'),
