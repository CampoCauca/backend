...
urlpatterns = [
  ...
  #--------------------------------------------URL Departamento------------------------------------------------------------------------#
    ...
    path('auth_group/', GrupoListado.as_view(template_name = "crud/auth_group/tables.html"), name='leerGrupo'),
 
    # La ruta 'detalles' en donde mostraremos una página con los detalles de un registro o Grupo 
    path('auth_group/detalle/<int:pk>', GrupoDetalle.as_view(template_name = "crud/auth_group/detalle.html"), name='detallesGrupo'),
 
    # La ruta 'actualizar' en donde mostraremos un formulario para actualizar un registro o Grupo de la Base de Datos 
    path('auth_group/editar/<int:pk>', GrupoActualizar.as_view(template_name = "crud/auth_group/actualizar.html"), name='actualizarGrupo'), 
 
    # La ruta 'eliminar' que usaremos para eliminar un registro o Grupo de la Base de Datos 
    path('auth_group/eliminar/<int:pk>', GrupoEliminar.as_view(), name='crud/auth_group/eliminar.html'), 
